...
class LaunchedURLClassLoaderTests {
	...
	@Test
	void testDefinePackage() throws MalformedURLException {
		LaunchedURLClassLoader loader = new LaunchedURLClassLoader(new URL[] {new URL("jar:file:src/test/resources/jars/app.jar!/")},
				getClass().getClassLoader());
		try {
			loader.loadClass("com.allen.Person");
